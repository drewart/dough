...
type panel struct {
	...
	Item    tview.Primitive // The panel's primitive.
...
func (p *Panels) AddPanel(name string, item tview.Primitive, resize, visible bool) {
	hasFocus := p.HasFocus()
...
func (p *Panels) GetFrontPanel() (name string, item tview.Primitive) {
	p.RLock()
	defer p.RUnlock()
...
func (p *Panels) Focus(delegate func(p tview.Primitive)) {
	p.Lock()
	defer p.Unlock()
...
func (p *Panels) MouseHandler() func(action tview.MouseAction, event *tcell.EventMouse, setFocus func(p tview.Primitive)) (consumed bool, capture tview.Primitive) {
...
func (p *Pages) AddPage(name string, item tview.Primitive, resize, visible bool) {
...
func (p *Pages) GetFrontPage() (name string, item tview.Primitive) {
